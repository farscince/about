...
Очень даже вероятно, что взглянув на проект, читатель сравнит его с детской игрушкой, но для меня это "Hello, чтоб его... JavaScript". А потому пора двигаться дальше. Следующая цель - изучить Node JS, понять, как он работает. В качестве параллельного проекта можно, скажем, создать подобный парсер, попутно опробовав модули и в идеале подключив, какую-нибудь БД.
